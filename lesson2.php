...
arrangeArrayAsc(array(2,5,7,4,-9,8));
echo "<br>";
...
$resultEx12 = insertElement(array(1, 2, 3, 4, 5), 6, 7);
...
$resultEx13 = removeElement(array(2,1,8,4,3,9,0,3,2,8));
...
$resultEx14 = positionElement(array("p","h","u","o","n","g"), "o");
...
reverseString("until i found him");
echo "<br>";
...
$resultEx16 = countElement([3,1,4,2,7]);
echo $resultEx16;
echo "<br>";
...
$resultEx18 = countOccurrences(["M","i","n","h","p","h","u","o","n","g"], "n");
...
$stringEx30 = "Oh i use to say";
$subStringEx30 = "I woul never fall in love, until i found him";
